...
### Non-Goals
Direct store-to-cloud master-data writes, cross-store voucher redemption, live B2B IRN e-invoicing, distributed multi-master consensus, automated supplier EDI, and optical prescription OCR are explicit non-goals for v1.6.5 (deferred to Phase 2.0, §18)."""
...
- **B2C Retail Checkout**: Conforms to CGST Section 31 with GSTIN, HSN, batch, expiry, tax breakdown, dynamic NPCI UPI QR (`upi://pay?...`), and audio confirmation (D-69). Optional WhatsApp share link (`wa.me`) provides paperless receipts (D-70).
